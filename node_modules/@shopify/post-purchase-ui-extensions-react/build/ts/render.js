...
function render(extensionPoint, render) {
    ...
    return (0, post_purchase_ui_extensions_1.extend)(extensionPoint, (root, input) => {
        (0, react_1.render)((0, jsx_runtime_1.jsx)(context_1.ExtensionInputContext.Provider, Object.assign({ value: input }, { children: render(input) })), root, () => {
            root.mount();
        });
        return {};
    });
